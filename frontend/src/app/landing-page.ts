    ...
    <main class="landing-page">
      ...
      <section class="landing-hero">
        <div class="landing-hero-copy">
          <span class="landing-kicker"><svg lucideShieldCheck />O profissional certo, na hora que você precisa</span>
          <h1>Precisou?<br />Indica<span>Fácil.</span></h1>
          <p>Encontre profissionais qualificados ou receba propostas para resolver qualquer problema com <b>rapidez e segurança.</b></p>
